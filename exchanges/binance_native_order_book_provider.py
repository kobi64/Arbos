...
ArbOS™
EX-234
Binance Native Order Book Provider

Connects the verified Binance SPOT order-book adapter to the
...
class BinanceNativeOrderBookProvider:
    def __init__(
        self,
        adapter,
    ):
    ...
    def snapshot(
        ...
        if (
            ...
            raise RuntimeError(
                "Binance order book unavailable: "
                f"{reason}"
            )
